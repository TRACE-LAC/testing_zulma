...
```{r casos-tip-cas, echo = FALSE, error = FALSE, fig.height=5, fig.width = 10, warning = FALSE, include = TRUE, message = FALSE}
casos_tip_cas <- agrupar_tipo_caso(data_event = data_event_filtrada)
```

```{r grafica-casos-tip-cas, fig.height = 5, fig.width = 11, fig.cap = paste0("Distribución de casos por clasificación - ", text_ext_geo)}
...
```{r grafica-casos-inicio-sintomas, fig.height = 5, fig.width = 11, fig.cap = paste0("Distribución de casos por fecha de inicio de sintomas - ", text_ext_geo), include = params$temporal_distribution, eval = params$temporal_distribution}
...
```{r grafica-casos-sex, fig.height = 4.8, fig.width = 8.4, fig.cap = paste0("Distribución de casos por sexo - ", text_ext_geo), include = params$epi_sex_distribution}
...
```{r grafica-casos-semanaepi, fig.height = 6, fig.width = 10, fig.cap =  paste0("Distribución de casos por sexo y semana epidemiológica - ", text_ext_geo), include = params$epi_sex_distribution, fig.pos = "H"}
...
```{r grafica-casos-edad, fig.height = 3, fig.width = 8, fig.cap =  paste0("Distribución de casos por edad - ", text_ext_geo), include = params$age_distribution}
...
```{r casos-edad-sex, fig.height = 3, fig.width = 9, fig.cap =  paste0("Distribución de casos por edad y sexo - ", text_ext_geo), include = params$age_sex_distribution && !mostrar_sex}
...
nomb_event <- unique(data_event_filtrada$nombre_evento)[1]
geo_ocurrencia <- obtener_tip_ocurren_geo(nombre_event = nomb_event)
if (params$departamento != "") {
...
```{r grafica-casos-mpios, fig.height = altura_fig_espacial, fig.width = 10, fig.cap = paste0("Distribución de casos por ", text_fig_geo), include = params$mpio_distribution && params$departamento != "" && params$municipio == "", eval = params$mpio_distribution && params$departamento != ""}
...
```{r mapa-casos, echo = FALSE, error = FALSE, warning = FALSE, include = TRUE, message = FALSE, cache = FALSE, results = FALSE, comment = FALSE, fig.height = 18, fig.width = 16, fig.cap = paste0("Distribución espacial de casos ", text_mapa_casos , " - ", text_ext_geo), include = params$spatial_distribution}
mapa
```
...
```{r casos-per-etn, fig.height = 3, fig.width = 8, fig.cap = paste0("Distribución de casos por pertenencia étnica - ", text_ext_geo), include = params$age_sex_distribution}
...
```{r grafica-incidencia-sex, fig.height = 3, fig.width = 7, fig.cap = paste0("Incidencia por sexo - ", text_ext_geo), include = params$epi_sex_distribution}
...
```{r mapa-incidencias, echo = FALSE, error = FALSE, warning = FALSE, include = TRUE, message = FALSE, cache = FALSE, results = FALSE, comment = FALSE, fig.height = 18, fig.width = 16, fig.cap = paste0("Incidencia según distribución geográfica ", text_mapa_inciden, " - ", text_ext_geo), include = params$spatial_distribution}
mapa
```
